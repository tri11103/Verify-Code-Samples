    ...
    if (json.length != 0) {
        ...
        for (var i = 0; i < json.length; i++) {    
            ...
            if (json[i].type != "error") {
				row.append("<td><svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 45 45'> <path fill='#f9e54e' d='M1.995 15h13.01a.937.937 0 0 0 .838-1.355L9.32.52a.907.907 0 0 0-1.64 0L1.157 13.645A.937.937 0 0 0 1.995 15zM8.018 5h.977v4h-.977zm-.523 6.476a1 1 0 0 1 2 0v.048a1 1 0 0 1-2 0z'/><path fill='none' d='M0 0h16v16H0z'/> </svg>" + json[i].type + "</td>");  
			} else {
				row.append("<td><svg xmlns='http://www.w3.org/2000/svg' width='32' height='32' viewBox='0 0 45 45' class='svg-icon'><path fill='#e4a793' d='M21.605 8l2.406 2.402-5.602 5.599 5.602 5.601L21.605 24l-5.598-5.599L10.405 24l-2.394-2.398 5.598-5.601-5.598-5.599L10.405 8l5.602 5.601L21.605 8zM32 10.6v10.801l-8.594 10.6H8.605L0 21.401V10.6L8.605 0h14.801L32 10.6zm-2.4 10.585V10.816l-6.822-8.415H9.235l-6.834 8.417v10.365L9.235 29.6h13.543l6.822-8.415z'/></svg>" + json[i].type + "</td>"); 
			}
